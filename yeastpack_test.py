...
class PhenomenalySim (object):
    ...
    def getListOfMetabolitesSummary (self, analysis_result, metabolite_dict = None):
        if metabolite_dict is None:
            metabolite_dict = {'a.D-Glucose-6-phosphate (c)': 's_0568',
                               'b.D-fructose-6-Phosphate (c)': 's_0557',
                               'c.Glyceraldehyde-3-Phosphate (c)': 's_0764',
                               'd.Phosphoenolpyruvate (c)': 's_1360',
                               'e.Phosphoenolpyruvate (m)': 's_1361',
                               'f.Pyruvate (c)': 's_1399',
                               'g.Pyruvate (m)': 's_1401',
                               'h.Acetaldehyde (c)': 's_0359',
                               #'i.Acetaldehyde (m)': 's_0361',
                               'j.Ethanol (c)': 's_0680',
                               'k.Ethanol (m)': 's_0682',
                               'l.Acetate (c)': 's_0362',
                               'm.Acetate (m)': 's_0365',
                               'n.Glycerol (c)': 's_0765',
                               'o.Acetyl-CoA (m)': 's_0376',
                               'p.Acetyl-CoA (c)': 's_0373',
                               'q.Citrate (c)': 's_0522',
                               'r.Citrate (m)': 's_0524',
                               's.Isocitrate (c)': 's_0940',
                               't.Isocitrate (m)': 's_0941',
                               'u.2-oxoglutarate (c)': 's_0180',
                               'v.2-oxoglutarate (m)': 's_0182',
                               'w.Succinyl-CoA (m)': 's_1464',
                               'x.Succinate (c)': 's_1458',
                               'y.Succinate (m)': 's_1460',
                               'z.Fumarate (c)': 's_0725',
                               'za.Fumarate (m)': 's_0727',
                               'zb.(S)-malate (c)': 's_0066',
                               'zc.(S)-malate (m)': 's_0068',
                               'zd.Oxaloacetate (c)': 's_1271',
                               'ze.Oxaloacetate (m)': 's_1273'
                               }
